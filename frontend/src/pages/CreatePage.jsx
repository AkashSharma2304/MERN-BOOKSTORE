              ...
              <div className='card-body'>
                ...
                <form onSubmit={handleSubmit}>
                  <div className='form-control mb-4'>
                    ...
                    <input text="text" placeholder='Book Title' className='input input-bordered' value={title} onChange={(e) => setTitle(e.target.value)} required/>
                  </div>
                  <div className='form-control mb-4'>
                    <label className='label'>
                  ...
                  <div className='form-control mb-4'>
                    ...
                    <input text='number' placeholder='e.g. 2025' className=' input input-bordered' value={publishYear} onChange={(e) => setPublishYear(e.target.value)}required/>
                  </div>
